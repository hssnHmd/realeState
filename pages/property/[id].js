...
const PropertyDetails = ({propertyDetails: {price, rooms ,rentFrequency, area, agency, title, isVerified, description,baths, type, purpose,furnishingStatus,amenities, photos}}) => (
    <Box width='1000px' p='4' margin='auto'>
